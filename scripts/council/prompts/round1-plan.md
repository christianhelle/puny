...
Critique the plan below. It has not been implemented yet, so judge the design,
its assumptions, and what it commits the author to — not code that does not exist.
