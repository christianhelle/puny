...
$GitHubRepo = "christianhelle/puny"
$BinaryName = "puny.exe"
$DocumentationUrl = "https://christianhelle.com/puny/"
...
{
  Write-Host ""
  Write-Host "Puny installation script for Windows" -ForegroundColor Blue
  Write-Host ""
  Write-Host "Usage:" -ForegroundColor Yellow
  Write-Host "  irm https://christianhelle.com/puny/install.ps1 | iex" -ForegroundColor White
  Write-Host ""
...
function Main
{
  ...
  Write-Info "Starting Puny installation for Windows..."
  ...
  $binaryPath = Install-Puny -ResolvedVersion $resolvedVersion -TargetDir $InstallDir
