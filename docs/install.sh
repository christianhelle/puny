...
GITHUB_REPO="christianhelle/puny"
BINARY_NAME="puny"
INSTALL_DIR="${INSTALL_DIR:-$HOME/.local/bin}"
DOCUMENTATION_URL="https://christianhelle.com/puny/"
...
Examples:
  ...
  curl -fsSL https://christianhelle.com/puny/install | INSTALL_DIR=\$HOME/.local/bin bash
  curl -fsSL https://christianhelle.com/puny/install | bash -s -- --version v0.1.0
EOF
}
...
main() {
  ...
  log_info "Starting Puny installation..."
  check_dependencies
